...
**url** | **str** | The URL of the token endpoint for the authentication code grant flow. The value should be in a URL format. | [optional] 
**token_name** | **str** | An optional alternative name to standard &#39;access_code&#39; OAuth2 parameter. | [optional] 
