...
**reset_password_enabled** | **bool** | Enables/disables support for resetting user passwords for the API Manager | [optional] [default to False]
**change_password_on_first_login** | **bool** | Enables/disables support for changing user passwords on first login for the API Manager | [optional] [default to False]
**password_expiry_enabled** | **bool** | Enables/disables support for user passwords expiration for the API Manager | [optional] [default to False]
**password_lifetime_days** | **int** | The number of days before user passwords expire for the API Manager | [optional] 
...
**application_scope_restrictions** | **bool** | Enables/disables the ability to show Application default enabled scopes only. | [optional] [default to False]
...
**strict_certificate_checking** | **bool** | For API import, strict certificate checking will only allow recognised, valid server certificates when performing API imports from SSL protected endpoints. Default is set to true | [optional] [default to False]
