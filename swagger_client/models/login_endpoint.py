...
class LoginEndpoint(object):
    ...
    def __init__(self, id=None, title=None, description=None, format=None, required=None, properties=None, items=None, example=None, discriminator=None, url=None, ref=None, default=None, type=None, enum=None):  # noqa: E501
